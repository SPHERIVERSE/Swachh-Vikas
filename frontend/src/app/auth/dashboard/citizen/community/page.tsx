        ...
        <div className="max-w-xl mx-auto">
          ...
          <header className="mb-6 border-b border-gray-700 pb-4 flex justify-between items-center sticky top-0 bg-gray-900 z-10">
            ...
            <div className="flex space-x-3">
              <button onClick={() => router.push('/auth/dashboard/citizen/community/explore')} className="px-4 py-2 bg-gray-700 text-gray-200 rounded-full text-sm font-semibold hover:bg-gray-600 transition-colors">Explore 🔍</button>
